...
// Define TypeScript-style interface as a JSDoc comment for documentation purposes
/**
 * @typedef {Object} Plan
 * @property {string} task
 * @property {Array<{title: string, details: string}>} steps
 */
 ...
 * @property {number} progress.currentStep
 * @property {number} progress.totalSteps
 * @property {Plan} [progress.plan]
 * @property {boolean} hasFinalAnswer
 */
...
export default function ProgressBar({
  ...
  return (
    <div className="w-full max-w-3xl mx-auto overflow-hidden flex flex-col">
      {isPlanning ? (
